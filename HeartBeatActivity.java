...
//    private static View image = null;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        progressBar = findViewById(R.id.heart_progress_bar);
...
//        image = findViewById(R.id.image);
        ...
        ImageButton simpleImageButtonHome = (ImageButton)findViewById(R.id.run);

        simpleImageButtonHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HeartBeatActivity.this, MainActivity.class);
...
//                image.postInvalidate();
            ...
            if (totalTimeInSecs >= 10) {
                ...
                progressBar.setProgress(beatsAvg/2);
                startTime = System.currentTimeMillis();
                beats = 0;
                stopCam();
            }
